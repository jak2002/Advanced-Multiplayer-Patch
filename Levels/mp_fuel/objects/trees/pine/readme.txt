...
This first pack of trees contains 5 spruces for use in northern maps. They can be used with the bending property and all kinds of shadows outdoors. Each one is a little different and having a separate texture. Alpha blending is generating stray lines around the texture, so avoid that in this version.
