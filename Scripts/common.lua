...
function logtable(table)
    System:Log(tostring("---Starting to list table: "..tostring(table).." ---"))
    for key,value in table do
        System:Log(tostring(key).." = "..tostring(value));
    end    
    System:Log(tostring("---Finishing to list table: "..tostring(table).." ---"))
end
