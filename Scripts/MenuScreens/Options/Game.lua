	...
	GUI=
	{
        ...
        phat=
        {
            ...
            OnChanged=function(Sender)
                UI.PageOptionsGame.Update3dModel();
                if (Sender:GetSelectionIndex()) then
                    setglobal("mp_hatmodel", Sender:GetSelectionIndex()-1);
                else
                    setglobal("mp_hatmodel", 0);
                end
            end,
        },
...
--			UI.PageOptionsGame.GUI.lefthanded:SetChecked(g_LeftHanded);
            ...
            UI.PageOptionsGame.GUI.phat:SelectIndex(getglobal("mp_hatmodel") + 1);
