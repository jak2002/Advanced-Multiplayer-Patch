...
function DefaultZoomHUD:DrawHUD(ZoomStep)
    ...
    local fAdjustTexW=1.0/512.0 * Hud.blow_scope;
    local fAdjustTexH=1.0/1024.0 * Hud.blow_scope;

		System:DrawImageColorCoords( DefaultZoomHUD.MulMask, 400, 0 + (600 - 600 * Hud.blow_scope) / 2, -400 * Hud.blow_scope, 600 * Hud.blow_scope, 7, 1, 1, 1, 1, 1-fAdjustTexW, 1-fAdjustTexH, fAdjustTexW, fAdjustTexH);
		System:DrawImageColorCoords( DefaultZoomHUD.MulMask, 400, 0 + (600 - 600 * Hud.blow_scope) / 2, 400 * Hud.blow_scope, 600 * Hud.blow_scope, 7, 1, 1, 1, 1, 1-fAdjustTexW, 1-fAdjustTexH, fAdjustTexW, fAdjustTexH);
	end
