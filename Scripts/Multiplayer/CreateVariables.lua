...
Game:CreateVariable("gr_RespawnTime", 10, "NetSynch");											-- in seconds, 0 to deactivate the respawning in waves
...
Game:CreateVariable("gr_max_average_ping",0);     							-- This sets the maximum allowed ping on the server; 0 means NO ping kick
...
Game:CreateVariable("gr_announce_headshot",0);                  -- 0 = no message, 1 = message on headshot kill
...
Game:CreateVariable("gr_stamina", 1, "NetSynch");				-- Stamina factor when running and jumping.